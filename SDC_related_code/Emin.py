# -*- coding: utf-8 -*-
"""
Created on Tue Feb 26 17:19:06 2019
...
sample_techfile_dict = plate_sample_techfile(5143, 69, 'CV2') # needs to be updated 
...
Emin = {sample_number:np.min(E_list) for sample_number, E_list in E.items()} # Emin = {sample number: Emin(V)}
