...
def sample_techfiles_from_plate(plate_id, sample_number):
    '''
    map plate_id --> sample_number --> techfiles, i.e. given plate_id and sample_number, retrieve all 
    the most recent techfiles associated with the sample inside the plate_id folder.
    
    input: plate_id (int: 4 digit), 
           sample_number (int: depend on the plate map).
    ...
    return sample_techfiles[sample_number]
